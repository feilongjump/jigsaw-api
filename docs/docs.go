    ...
    "paths": {
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\": 200, \"msg\": \"成功\", \"data\": \"token...\"}",
                        "schema": {
                            "allOf": [
                                {
                    ...
                    "422": {
                        "description": "{\"code\": 422, \"msg\": \"参数校验失败\", \"data\": null, \"errors\": {...}}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/auth/register": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\": 200, \"msg\": \"成功\", \"data\": null}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/files/upload": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\": 200, \"msg\": \"成功\", \"data\": {\"path\": \"/static/image/2026-02-21/120102_ab12cd34.png\"}}",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/posts": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\": 200, \"msg\": \"成功\", \"data\": [...]}",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
